...
fig=plt.figure()
ax=fig.add_subplot(111,projection='3d')
scat=ax.scatter(x[mask_lower],y[mask_lower],z[mask_lower])
plt.show()
...
def find_delta_sigma():
    ...
    before_correction_undelta_upper = bz_mask_delta
    before_correction_unsigma_upper = bz_std
    print
    ...
    after_correction_undelta_upper = bz_residual_delta
    after_correction_unsigma_upper = bz_residual_std
    print
    ...
    before_correction_undelta_lower = bz_mask_delta
    before_correction_unsigma_lower = bz_std
    print
    ...
    after_correction_undelta_lower = bz_residual_delta
    after_correction_unsigma_lower = bz_residual_std
    ...
    print()
    print('Delta(B_z) upper before %f after %f' %
          (before_correction_delta_upper, after_correction_delta_upper))
    print('Delta(B_z) lower before %f after %f' %
          (before_correction_delta_lower, after_correction_delta_lower))
    print('Sigma(B_z) upper before %f after %f' %
          (before_correction_sigma_upper, after_correction_sigma_upper))
    print('Sigma(B_z) lower before %f after %f' %
          (before_correction_sigma_lower, after_correction_sigma_lower))
    print('unDelta(B_z) upper before %e after %e' %
          (before_correction_undelta_upper, after_correction_undelta_upper))
    print('unDelta(B_z) lower before %e after %e' %
          (before_correction_undelta_lower, after_correction_undelta_lower))
    print('unSigma(B_z) upper before %e after %e' %
          (before_correction_unsigma_upper, after_correction_unsigma_upper))
    print('unSigma(B_z) lower before %e after %e' %
          (before_correction_unsigma_lower, after_correction_unsigma_lower))
    ...
    dict = {'BC_DBz_upper': before_correction_delta_upper,
            'AC_DBz_upper': after_correction_delta_upper,
            'BC_DBz_lower': before_correction_delta_lower,
            'AC_DBz_lower': after_correction_delta_lower,
            'BC_SBz_upper': before_correction_sigma_upper,
            'AC_SBz_upper': after_correction_sigma_upper,
            'BC_SBz_lower': before_correction_sigma_lower,
            'AC_SBz_lower': after_correction_sigma_lower,
            'BC_UNDBz_upper': before_correction_undelta_upper,
            'AC_UNDBz_upper': after_correction_undelta_upper,
            'BC_UNDBz_lower': before_correction_undelta_lower,
            'AC_UNDBz_lower': after_correction_undelta_lower,
            'BC_UNSBz_upper': before_correction_unsigma_upper,
            'AC_UNSBz_upper': after_correction_unsigma_upper,
            'BC_UNSBz_lower': before_correction_unsigma_lower,
            'AC_UNSBz_lower': after_correction_unsigma_lower,
            }
    return dict


#df = pd.DataFrame(columns=['xd', 'yd', 'zd',
#                           'mx', 'my', 'mz',
#                           'BC_DBz_upper', 'AC_DBz_upper',
#                           'BC_DBz_lower', 'AC_DBz_lower',
#                           'BC_SBz_upper', 'AC_SBz_upper',
#                           'BC_SBz_lower', 'AC_SBz_lower',
#                           'BC_UNDBz_upper', 'AC_UNDBz_upper',
#                           'BC_UNDBz_lower', 'AC_UNDBz_lower',
#                           'BC_UNSBz_upper', 'AC_UNSBz_upper',
#                           'BC_UNSBz_lower', 'AC_UNSBz_lower',
#                           ])
df=pd.DataFrame()

for trial in range(50000):
    d.random(1.2)
    dict_dipole = {'xd':d.xd, 'yd':d.yd, 'zd':d.zd,
            'mx':d.mx, 'my':d.my, 'mz':d.mz}
    #BC_DBz_upper, AC_DBz_upper, BC_DBz_lower, AC_DBz_lower, BC_SBz_upper, AC_SBz_upper, BC_SBz_lower, AC_SBz_lower, BC_UNDBz_upper, AC_UNDBz_upper, BC_UNDBz_lower, AC_UNDBz_lower, BC_UNSBz_upper, AC_UNSBz_upper, BC_UNSBz_lower, AC_UNSBz_lower = find_delta_sigma()
    dict_fields=find_delta_sigma()
    merged=dict_dipole|dict_fields
    df=df.append(merged,ignore_index=True)

#    df.loc[len(df)] = [d.xd, d.yd, d.zd,
#                       d.mx, d.my, d.mz,
#                       BC_DBz_upper, AC_DBz_upper,
#                       BC_DBz_lower, AC_DBz_lower,
#                       BC_SBz_upper, AC_SBz_upper,
